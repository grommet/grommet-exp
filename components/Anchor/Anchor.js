...
const Anchor = forwardRef((_a, ref) => {
    var { children, disabled, href, icon, label, reverse } = _a, rest = __rest(_a, ["children", "disabled", "href", "icon", "label", "reverse"]);
    ...
    return (jsx("a", Object.assign({ className: anchor, ref: ref }, rest, { href: !disabled ? href : undefined }, { children: content })));
});
